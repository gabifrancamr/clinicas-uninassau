...
export function Map() {
  return (
    <Flex id="location" flexDirection={"column"} alignItems={"center"} marginTop={"8"} paddingX={{ base: "4", md: "8", lg: "24" }} >
      ...
      <Box>
        ...
        <Flex gap={2} alignItems={"flex-start"}>
          ...
          <Text fontSize={{ base: "lg", lg: "xl" }} mb={6} className="text">São duas entradas para melhor te receber: pela Av. Jockey Club, ao lado da Casa das Linhas, e pela Rua Napoleão Lima, nº 1175.</Text>
        </Flex>
      </Box>
