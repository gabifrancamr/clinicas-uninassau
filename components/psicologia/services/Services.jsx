...
import psychologyServices from '../../../data/psicologia.json'
...
export function Services() {
    const { psychology_services } = psychologyServices;
  ...
  return (
    ...
    >
      ...
      {/* Cards animados */}
      <Flex flexDirection={"column"} alignItems="stretch" justifyContent="center" w="100%">
        {psychology_services.map((item, i) => (
          <motion.div
            key={item.category}
